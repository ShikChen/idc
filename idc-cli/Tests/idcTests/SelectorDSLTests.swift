...
final class SelectorDSLTests: XCTestCase {
    ...
    func testIsAndNot() throws {
        ...
        XCTAssertEqual(notProgram, plan(
            .descendants(type: "button"),
            .matchPredicate("(NOT ((isEnabled == true)))")
        ))
    }
